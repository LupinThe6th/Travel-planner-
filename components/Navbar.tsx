...
export default function NavBar({session} : {session: Session | null}) {
    ...
    return (
    <nav className="bg-white shadow-md py-4 border-b border-grey-200">
        <div className = "container mx-auto flex justify-between items-center px-6 lg:px-8">
            ...
            <div className = "flex items-center space-x-4">
                ...
                <button className = "flex items-center justify-center bg-gray-800 text-white hover:bg-gray-900 p-2 rounded-sm cursor-pointer" onClick={logout}>
                    Sign Out
                </button>
                </>
                ) : (
                <>
                <button className = "flex items-center justify-center bg-gray-800 text-white hover:bg-gray-900 p-2 rounded-sm cursor-pointer" onClick={() => login("github")}>
                  ...
                  <button className=" flex items-center justify-center p-2 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50  disabled:opacity-50 cursor-pointer transition-colors" onClick={() => login("google")}>
